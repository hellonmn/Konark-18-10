...
Route::middleware(['auth', 'role:representative'])->group(function () {
    ...
    Route::get('/doctors/collaborate', [DoctorController::class, 'collaborateShow'])->name('doctors.collaborate.show');
    Route::post('/doctors/collaborate/submit', [DoctorController::class, 'collabFormStore'])->name('doctors.collaborate.store');
    Route::get('/doctors/thankyou', [DoctorController::class, 'thankyou'])->name('doctors.collaborate.thankyou');
});

Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');

Route::middleware(['auth', 'role:admin'])->group(function () {
    // Representative management routes (admin-only)
    Route::delete('/representative/doctors/{id}', [RepresentativeController::class, 'destroyDoctor'])->name('representatives.doctor.destroy');
