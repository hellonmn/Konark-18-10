                        ...
                        <div class="bg-white rounded-xl w-full">
                            <div class="container mx-auto">
                                ...
                                <div class="flex justify-between mb-4">
                                    <button id="prevMonth" class="bg-blue-500 text-white px-4 py-2 rounded">Previous Month</button>
                                    <div id="currentMonth" class="text-lg font-semibold"></div>
                                    <button id="nextMonth" class="bg-blue-500 text-white px-4 py-2 rounded">Next Month</button>
                                </div>

                                <div id="calendar" class="grid grid-cols-7 gap-1 mb-4"></div>

                                <!-- Event Display Area -->
                                <div id="eventDetails" class="p-4 bg-gray-100 rounded-lg"></div>

                                <button onclick="window.history.back()" class="bg-red-500 text-white px-4 py-2 rounded">Back</button>
                            </div>
                        </div>
