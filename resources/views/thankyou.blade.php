...
<body>
        <header>
            <h2 class="headerTitle">Joy konark CBCT Centre</h2>
    ...
    <div class="container2">
        <div class="sliderParent">
            <div class="introBox">
                ...
                <h4 class="introTitle">Form Submitted</h4>
                <p class="introSubtitle">Thank you for taking the time to fill out our form.</p>
                <br>
