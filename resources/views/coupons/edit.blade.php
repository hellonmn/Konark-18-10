            ...
            <div class="p-5 bg-white rounded-xl w-full">
                ...
                <div class="container mx-auto">
                    ...
                    <div class="tab-content mt-6" id="general">
                        <form class="max-w-sm" action="{{ route('coupons.update', ['id' => $coupon->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Enter patient name" value="{{$coupon->name}}" required />
                            </div>
                            <div class="mb-4">
                                <label for="name" class="block text-sm font-medium text-gray-700">Coupon
                                    Code</label>
                                <input type="text" name="code" id="code"
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                    placeholder="Enter coupon code" value="{{$coupon->code}}" required />
                            </div>
                            <div class="mb-4">
                                <label for="expiry" class="block text-sm font-medium text-gray-700">Expiry Date</label>
                                <input type="date" name="expiry" id="expiry"
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                    placeholder="Select expiry date" value="{{$coupon->expiry}}" required />
                            </div>
                            @if ($coupon->is_fix)
                                <div class="mb-4">
                                    <label for="amount" class="block text-sm font-medium text-gray-700">Discount Amount</label>
                                    <input type="text" name="amount" id="amount"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                        placeholder="Enter discount amount" value="{{$coupon->amount}}" required />
                                </div>
                            @else
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="percentage" id="percentage"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                        placeholder="Enter percentage discount" value="{{$coupon->percentage}}" required />
                                </div>
                            @endif
                            <div class="mb-4">
                                    <label for="max" class="block text-sm font-medium text-gray-700">Maximum Discount Amount</label>
                                    <input type="text" name="max" id="max"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                        placeholder="Enter maximum discount price" value="{{$coupon->max}}" required />
                                </div>
                            <div class="mb-4">
                                    <label for="min" class="block text-sm font-medium text-gray-700">Minimum Eligibility Amount</label>
                                    <input type="text" name="min" id="min"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-primary focus:border-primary sm:text-sm"
                                        placeholder="Enter minimum discount price" value="{{$coupon->min}}" required />
                                </div>
